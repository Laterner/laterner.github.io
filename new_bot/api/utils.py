...
QUIZES = [
    ...
    {'question': 'Как зовут персонажа Т-Банка, который играет в квиз?', 'secret_code': 'UZQYX', 'answers': ['А) Изик', 'Б) Бизик', 'В) Квизик', ' Г) Шизик'], 'ans': 3},
    {'question': 'Сколько лет в этом году исполняется Т-банку?', 'secret_code': 'VGNMD', 'answers': ['А) 10', 'Б) 15', 'В) 20', ' Г) 25'], 'ans': 3},
    {'question': 'Какой сегодня день недели?', 'secret_code': 'XTHFL', 'answers': ['А) Вторник', 'Б) Среда', 'В) Четверг', ' Г) Пятница'], 'ans': 3}
]
